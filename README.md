...
Each chunk is converted into an embedding (via Gemini) and stored in ChromaDB
When you ask a question, it's embedded too and matched against the stored chunks
The most relevant chunks are sent to Gemini along with your question to generate an answer
Project Structure
backend/
  app/
